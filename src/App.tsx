...
const TimerTab = lazy(() => import('./components/Timer/TimerTab'))
const HistoryTab = lazy(() => import('./components/History/HistoryTab'))
const GymTab = lazy(() => import('./components/Gym/GymTab'))
const WeightTab = lazy(() => import('./components/Weight/WeightTab'))
const MeasurementsTab = lazy(() => import('./components/Measurements/MeasurementsTab'))
